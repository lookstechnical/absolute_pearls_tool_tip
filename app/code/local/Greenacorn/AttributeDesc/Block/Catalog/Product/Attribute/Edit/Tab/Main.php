 ...
 *
 */
class Greenacorn_AttributeDesc_Block_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('attr_desc', 'textarea', array(
            'name' => 'attr_desc',
            'label' => Mage::helper('catalog')->__('Attribute Description'),
            'title' => Mage::helper('catalog')->__('Attribute Description'),
        ));
